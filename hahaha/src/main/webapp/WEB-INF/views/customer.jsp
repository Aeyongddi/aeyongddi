...
<script type="text/javascript">
	function showDetails(name, ssn, email, passport, phone, address) {
...
<body>
		...
		<form id="frm01" class="form" method="post">
			<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
				...
				<!-- <button class="btn btn-info" type="submit">
					<<i class="bi bi-search"><svg xmlns="http://www.w3.org/2000/svg"
  ...
  <path
				...
				&nbsp; <input placeholder="여권번호" name="passport_number"
					class="form-control mr-sm-2" />
				<button class="btn btn-info" type="submit">
					<i class="bi bi-search"><svg xmlns="http://www.w3.org/2000/svg"
							width="16" height="16" fill="currentColor" class="bi bi-search"
					...
					<tr>
						...
						<td>
							<button type="button" class="btn btn-success"
								onclick="showDetails('${cus.name}', '${cus.ssn}', '${cus.email}', '${cus.passport_number}', '${cus.phone}', '${cus.address}')">
					...
					<form id="frm02" class="form" method="post">
						<div class="form-group">
							<label for="modal-name"><strong>이름:</strong></label> <input
								type="text" class="form-control" id="modal-name"  readonly value="">
						</div>
						<div class="form-group">
							<label for="modal-ssn"><strong>주민번호:</strong></label> <input
								type="text" class="form-control" id="modal-ssn"  value="">
						</div>
						<div class="form-group">
							<label for="modal-email"><strong>이메일:</strong></label> <input
								type="email" class="form-control" id="modal-email" readonly value="">
						</div>
						<div class="form-group">
							<label for="modal-passport"><strong>여권번호:</strong></label> <input
								type="text" class="form-control" id="modal-passport" value="">
						</div>
						<div class="form-group">
							<label for="modal-phone"><strong>전화번호:</strong></label> <input
								type="text" class="form-control" id="modal-phone"  readonly value="">
						</div>
						<div class="form-group">
							<label for="modal-address"><strong>주소:</strong></label> <input
								type="text" class="form-control" id="modal-address"  readonly value="">
						</div>
					</form>
				</div>
