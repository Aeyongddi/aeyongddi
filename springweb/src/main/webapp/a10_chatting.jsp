...
<div class="container">
	<div class="input-group mb-3">	
		...
		<input type="button" class="btn btn-primary" value="채팅창 입장" id="enterBtn" />	
		<input type="button" class="btn btn-danger" value="채팅창 나가기" id="exitBtn" />	
	</div>	
	<div class="input-group mb-3">	
		<div class="input-group-prepend ">
	...
	<div class="input-group mb-3">	
		<div class="input-group-prepend ">
			<span class="input-group-text  justify-content-center">전송 메시지</span>
		</div>
		<input id="msg" class="form-control" value="" placeholder="전송할 메시지 입력"/>	
		<input type="button" class="btn btn-info" value="메시지 전송" id="sndBtn" />	
		</div>
	<div class="input-group mb-3">	
		<div class="input-group-prepend ">
			<span class="input-group-text  justify-content-center">기타 기능</span>
		</div>	
