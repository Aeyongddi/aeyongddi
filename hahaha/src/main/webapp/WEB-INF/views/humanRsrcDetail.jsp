...
<div class="container" >
	...
	<div class="input-group mb-3">	
		...
		<input type="number" name="user_employee_id" class="form-control" value="${emp.user_employee_id}" 
			readonly/>	
	</div>	
	<div class="input-group mb-3">	
		<div class="input-group-prepend ">
	...
	<div class="input-group mb-3">	
		...
		<input name="position" class="form-control" value="${emp.position}" />	
	</div>	
	
	<div style="text-align:right;">
			<input type="button" class="btn btn-success" value="등록/수정" id="uptInsBtn"/>
