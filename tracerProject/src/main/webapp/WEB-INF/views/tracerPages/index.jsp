...
<jsp:include page="/headerSidebar.jsp"/>
  ...
  <path fill-rule="evenodd" d="M4.646 1.646a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1 0 .708l-6 6a.5.5 0 0 1-.708-.708L10.293 8 4.646 2.354a.5.5 0 0 1 0-.708z"/>
							     ...
							     <div class="item p-3">
								    <div class="row align-items-center">
									    <div class="col">
										    <div class="title mb-1 ">프로젝트 HMM</div>
										    <div class="progress">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="settingsModalLabel">바로가기 설정</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form id="settingsForm">
                        <div class="mb-3">
                            <label for="linkText" class="form-label">링크 텍스트</label>
                            <input type="text" class="form-control" id="linkText" placeholder="예: google.com">
                        </div>
                        <div class="mb-3">
                            <label for="linkUrl" class="form-label">URL</label>
                            <input type="url" class="form-control" id="linkUrl" placeholder="예: https://www.google.com">
                        </div>
                        <div class="mb-3">
                            <label for="linkIndex" class="form-label">링크 위치 (1-5)</label>
                            <input type="number" class="form-control" id="linkIndex" min="1" max="5">
                        </div>
                    </form>
                </div>
			        ...
			        <div class="col-12 col-lg-6">
				        <div class="app-card app-card-stats-table h-100 shadow-sm">
					        <div class="app-card-header p-3">
						        <div class="row justify-content-between align-items-center">
							        <div class="col-auto">
						                <h4 class="app-card-title">바로가기</h4>
							        </div><!--//col-->
							        <div class="col-auto">
								        <div class="card-header-action">
									         <a href="#" data-bs-toggle="modal" data-bs-target="#settingsModal">설정</a>
								        </div><!--//card-header-actions-->
							        </div><!--//col-->
						        </div><!--//row-->
					        </div><!--//app-card-header-->
						        ...
						        <div class="table-responsive">
							        <table class="table table-borderless mb-0">
										...
										<tbody>
											...
											<tr>
												<td><a href="https://w3schools.com">w3schools.com</a></td>
											</tr>
											<tr>
    ...
    <script>
        $(document).ready(function() {
            $('#saveSettings').click(function() {
                ...
                if (linkText && linkUrl && linkIndex) {
                    var tableRows = $('table tbody tr');
                    var row = tableRows.eq(linkIndex - 1); 
                    // 링크 위치는 1부터 시작하므로 인덱스 조정

                    row.find('a').attr('href', linkUrl).text(linkText);
