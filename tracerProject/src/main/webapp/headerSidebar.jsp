...
<header class="app-header fixed-top">
	...
	<div id="app-sidepanel" class="app-sidepanel">
		...
		<div class="sidepanel-inner d-flex flex-column">
			...
			<div class="app-branding">
				<a class="app-logo" href="index${user_info.auth == 'member' ? 'U' : 'M'}"><img class="logo-icon me-2"
					src="image/logo.png" alt="logo"><span class="logo-text">TRACER</span></a>
			</div>
			<!--//app-branding-->
			<nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
				<ul class="app-menu list-unstyled accordion" id="menu-accordion">
					<li class="nav-item"><a class="nav-link" href="index${user_info.auth == 'member' ? 'U' : 'M'}"> <span
    ...
    <a class="nav-link submenu-toggle" href="#" data-bs-toggle="collapse" data-bs-target="#project-submenu" aria-expanded="false" aria-controls="project-submenu">
        <span class="nav-icon">
            <svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke-width="1.5" stroke="currentColor" class="bi bi-folder">
                <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 3v11.25A2.25 2.25 0 0 0 6 16.5h2.25M3.75 3h-1.5m1.5 0h16.5m0 0h1.5m-1.5 0v11.25A2.25 2.25 0 0 1 18 16.5h-2.25m-7.5 0h7.5m-7.5 0-1 3m8.5-3 1 3m0 0 .5 1.5m-.5-1.5h-9.5m0 0-.5 1.5M9 11.25v1.5M12 9v3.75m3-6v6" />
            </svg>
        </span>
        <span class="nav-link-text">프로젝트 관리</span>
    ...
    <div id="project-submenu" class="collapse submenu">
        <ul class="submenu-list list-unstyled">
        	<li class="submenu-item"><a class="submenu-link nomem" href="newPrj"><span class="nav-link-text">새 프로젝트 생성</span></a></li>
            <li class="submenu-item"><a class="submenu-link nomem nomgr" href="prjList"><span class="nav-link-text">프로젝트 목록</span></a></li>
            <li class="submenu-item"><a class="submenu-link noprj" href="${user_info.auth == 'member' ? 'prjInfo' : 'prjDetail'}?pid=${user_info.pid}"><span class="nav-link-text">프로젝트정보[인적자원 관리]</span></a></li>
            <li class="submenu-item"><a class="submenu-link noprj" href="teamList?pid=${user_info.pid}"><span class="nav-link-text">팀 목록</span></a></li>
            <li class="submenu-item"><a class="submenu-link nomem noprj" href="newTeam"><span class="nav-link-text"> 팀 생성하기</span></a></li>
            <li class="submenu-item"><a class="submenu-link noteam" href="${user_info.auth == 'member' ? 'teamInfo' : 'teamDetail'}?tid=${user_info.tid}"><span class="nav-link-text">팀 정보[인적자원 관리]</span></a></li>
        </ul>
    </div>
</li>
					<!--//nav-item-->
