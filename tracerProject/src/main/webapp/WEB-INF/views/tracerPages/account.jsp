...
<body class="app">
	...
	<div class="app-wrapper">
		...
		<div class="app-content pt-3 p-md-3 p-lg-4">
			<div class="container-xl">
				...
				<h1 class="app-page-title">사용자 관리</h1>
				<div class="row gy-4">
							...
							<div class="app-card-body px-4 w-100">
									...
									<div class="modal-dialog" role="document">
										<div class="modal-content">
											<div class="modal-header">
												<h5 class="modal-title">닉네임 변경하기</h5>
											...
											<div class="modal-footer">
												...
												<button type="button" class="btn btn-primary"
													id="saveNicknameBtn">저장하기</button>
											</div>
										</div>
									</div>
								</div>
								...
								<div class="modal" id="changePhoneModal" tabindex="-1"
									...
									<div class="modal-dialog" role="document">
										<div class="modal-content">
											<div class="modal-header">
												<h5 class="modal-title">전화번호 변경하기</h5>
												<button type="button" class="close" data-bs-dismiss="modal"
													aria-label="Close">
													<span aria-hidden="true">&times;</span>
												</button>
  ...
  <path fill-rule="evenodd"
									...
									<!--//col-->
									<div class="col-auto">
										<h4 class="app-card-title">기타 설정</h4>
									</div>
									<!--//col-->
								</div>
								<!--//row-->
							...
							<div class="app-card-footer p-4 mt-auto">
								<a class="btn app-btn-primary" href="#" id="deleteAccountBtn">회원
									탈퇴</a>
							</div>
							<!--//app-card-footer-->
									...
									<div class="modal-content">
										...
										<div class="modal-footer">
											...
											<button type="button" class="btn btn-danger"
												id="confirmDeleteBtn">탈퇴하기</button>
										</div>
									</div>
								</div>
							</div>
				...
				<form>
					...
					<div class="modal-footer">
						<button type="button" class="btn btn-secondary clsBtn"
							data-bs-dismiss="modal">닫기</button>
						<button type="button" class="btn btn-primary chgPwdBtn">비밀번호
							변경하기</button>
					</div>
				</form>
			</div>
