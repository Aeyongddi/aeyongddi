...
<jsp:include page="/headerSidebar.jsp"/>s
                                    ...
                                    <table class="table app-table-hover mb-0 text-left">
                                        ...
                                        <tbody>
                                            <tr v-for="user in users" :key="user.email" :class="user.email">
                                                ...
                                                <td class="cell"><button @click="deleteUser(user.email)" class="btn-sm app-btn-secondary">삭제</button></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    <div class="pagination mt-3">
                                        <a href="#" v-for="page in totalPages" :key="page" @click.prevent="fetchUsers(page - 1)" class="page-link">{{ page }}</a>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script>
    	const BASEURL = "http://localhost:5656/userManagement"
        new Vue({
            el: '#app',
            data() {
                return {
