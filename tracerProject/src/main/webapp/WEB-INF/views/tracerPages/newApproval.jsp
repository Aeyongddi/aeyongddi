        ...
        <div class="app-content pt-3 p-md-3 p-lg-4">
            <div class="container-xl">
                ...
                <nav id="orders-table-tab" class="orders-table-tab app-nav-tabs nav shadow-sm flex-column flex-sm-row mb-4">
                    ...
                    <a class="flex-sm-fill text-sm-center nav-link" id="orders-waiting-tab" data-bs-toggle="tab" href="#orders-waiting" role="tab" aria-controls="orders-waiting" aria-selected="false">결재 대기</a>
                    <a class="flex-sm-fill text-sm-center nav-link" id="orders-hold-tab" data-bs-toggle="tab" href="#orders-hold" role="tab" aria-controls="orders-hold" aria-selected="false">보류</a>
                ...
                <div class="tab-content" id="orders-table-tab-content">
                            ...
                            <tbody>
                                <c:forEach var="approval" items="${approvals}">
                                    <tr>
                                        ...
                                        <td>${approval.tkid}</td>
                                        <td>
                                            <button type="button" class="btn btn-info" data-bs-toggle="modal" data-bs-target="#approvalModal-${approval.apid}">상세 보기</button>
                                        </td>
                                    </tr>
                                </c:forEach>
                            </tbody>
                    ...
                    <!-- 결재 대기 탭 -->
                    <div class="tab-pane fade" id="orders-waiting" role="tabpanel" aria-labelledby="orders-waiting-tab">
                        <table class="table table-hover">
                            <thead>
                                <tr>
                                    <th>APID</th>
                    ...
                    <!-- 보류 탭 -->
                    <div class="tab-pane fade" id="orders-hold" role="tabpanel" aria-labelledby="orders-hold-tab">
                        <table class="table table-hover">
                            <thead>
                                <tr>
                                    <th>APID</th>
