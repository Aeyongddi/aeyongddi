...
<body>
        ...
        <div class="app-content pt-3 p-md-3 p-lg-4">
            <div class="container-xl">
                ...
                <nav id="orders-table-tab" class="orders-table-tab app-nav-tabs nav shadow-sm flex-column flex-sm-row mb-4">
                    <a class="flex-sm-fill text-sm-center nav-link" id="hr-management-tab" data-bs-toggle="tab" href="#hr-management" role="tab" aria-controls="hr-management" aria-selected="false">인적 자원 관리</a>
                ...
                <div class="tab-content" id="orders-table-tab-content">
                    <div class="tab-pane fade" id="hr-management" role="tabpanel" aria-labelledby="hr-management-tab">
                                        ...
                                        <tbody>
                                            <c:forEach var="user" items="${userInfoList}">
                                                <tr>
                                                    ...
                                                    <td class="cell"><c:forEach var="team" items="${user.teams}">
                                                        ${team.tid}<br>
                                                    </c:forEach></td>
                                                    <td class="cell"><c:forEach var="project" items="${user.projects}">
                                                        ${project.title}<br>
                                                    </c:forEach></td>
                                                </tr>
                                            </c:forEach>
                        ...
                        <div class="app-card app-card-chart h-100 shadow-sm">
                            <div class="app-card-header p-3 border-0">
                                <div class="left-section">
                                    ...
                                    <select class="form-select form-select-sm ms-3 d-inline-flex w-auto" id="budgetProjectSelect">
    ...
    $(document).ready(function() {
        function updateChart(pid) {
            $.ajax({
                ...
                success: function(data) {
                    var assignedBudget = data.assigned_budget;
                    var usedBudget = data.used_budget;
                    var remainingBudget = assignedBudget - usedBudget;

                    budgetDonutChart.data.datasets[0].data = [usedBudget, remainingBudget];
        ...
        if (activeTab) {
            ...
            $('#orders-table-tab a[href="#asset-management"]').tab('show');
        }
    });
    </script>
</body>
