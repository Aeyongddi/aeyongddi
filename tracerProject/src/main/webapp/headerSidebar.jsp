			...
			<nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
				<ul class="app-menu list-unstyled accordion" id="menu-accordion">
					<li class="nav-item"><a class="nav-link" href="index"> <span
						...
						</span> <span class="nav-link-text"><fmt:message key='main.screen' /></span>
					</a>
					<!--//nav-link--></li>
					<!--//nav-item-->
					...
					<li class="nav-item"><a class="nav-link" href="timeline">
						...
						</span> <span class="nav-link-text"><fmt:message key='timeline' /></span>
					</a>
					<!--//nav-link--></li>
					<!--//nav-item-->
					<li class="nav-item"><a class="nav-link" href="orders.jsp">
						...
						</span> <span class="nav-link-text"><fmt:message key='calendar' /></span>
					</a>
					<!--//nav-link--></li>
					<!--//nav-item-->
        ...
        <ul class="submenu-list list-unstyled">
            ...
            <li class="submenu-item"><a class="submenu-link" href="#" onclick="openChat('private')">개인 채팅</a></li>
					...
					<li class="nav-item"><a class="nav-link" href="prjList"> <span
						...
						</span> <span class="nav-link-text"><fmt:message
									key='notifications' /></span>
					</a>
					<!--//nav-link--></li>
					<!--//nav-item-->
				</ul>
			...
			<div class="app-sidepanel-footer">
				<nav class="app-nav app-nav-footer">
					<ul class="app-menu footer-menu list-unstyled">
						<li class="nav-item">&nbsp; TRACER는 <br> &nbsp; 당신의 행보를
							항상 응원합니다. <br> &nbsp; 행복하자 우리 아프지말고<br> &nbsp; 다치지말고
						</li>
						<!--//nav-item-->
					</ul>
					<!--//footer-menu-->
